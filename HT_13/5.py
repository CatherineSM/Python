...
def init_library():
    ...
    book5 = Book("Дамы и господа", "Терри Пратчет", 1992, "Фентези")
    book6 = Book("Ночная Стража", "Терри Пратчет", 2002, "Фентези")
    librarian.add_book(book1, 5)
    librarian.add_book(book2, 1)
    librarian.add_book(book3, 2)
    librarian.add_book(book4, 3)
    librarian.add_book(book5, 10)
    librarian.add_book(book5, 5)
